...
if line_one[0] == 1 and line_two[1] == 1 and line_three[2] == 1:
    ...
    FP_WIN = True
elif line_one[0] == 1 and line_one[0] == 1 and line_one[0] == 1:
    FP_WIN = True
...
if line_one[0] == 2 and line_two[1] == 2 and line_three[2] == 2:
    SP_WIN = True
    ...
    SP_WIN = True
elif line_one[0] == 2 and line_one[0] == 2 and line_one[0] == 2:
    SP_WIN = True
